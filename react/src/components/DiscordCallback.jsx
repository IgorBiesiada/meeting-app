...
export default function DiscordCallback() {
  ...
  const [status, setStatus] = useState("Trwa logowanie przez Discord...");
  ...
  return (
    <div className="min-h-[calc(100vh-5rem)] flex flex-col items-center justify-center bg-gray-900 text-white p-6">
      ...
      <div className={`text-xl font-bold mb-4 ${errorDetails ? 'text-red-500' : 'text-indigo-400 animate-pulse'}`}>
        {status}
      </div>
      {errorDetails && (
